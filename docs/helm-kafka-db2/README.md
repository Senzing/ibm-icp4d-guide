# ibm-icp4d-guide-helm-kafka-db2
...
1. Perform Helm install.  Example:
    ...
    helm install ${HELM_TLS} \
      ...
      --namespace ${DEMO_NAMESPACE} \
      --values ${GIT_REPOSITORY_DIR}/helm-values/mock-data-generator-kafka.yaml \
...
1. Perform Helm install.  Example:
    ...
    helm install ${HELM_TLS} \
      ...
      --namespace ${DEMO_NAMESPACE} \
      --values ${GIT_REPOSITORY_DIR}/helm-values/stream-loader-kafka.yaml \
