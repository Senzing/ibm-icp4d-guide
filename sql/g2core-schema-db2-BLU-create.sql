...
CREATE TABLE SYS_CFG (CFG_ID smallint NOT NULL, CONFIG_DATA_ID BIGINT NOT NULL, CONFIG_DATA CLOB NOT NULL, SYS_CREATE_DT TIMESTAMP NOT NULL) ORGANIZE BY ROW;
...
CREATE TABLE SYS_EVAL_QUEUE (LENS_CODE VARCHAR(25) NOT NULL, ETYPE_CODE VARCHAR(25) NOT NULL, DSRC_CODE VARCHAR(25) NOT NULL, ENT_SRC_KEY VARCHAR(200) NOT NULL, MSG CLOB) ORGANIZE BY ROW ;
...
CREATE TABLE DSRC_RECORD (DSRC_ID smallint NOT NULL, RECORD_ID VARCHAR(250) NOT NULL, ETYPE_ID smallint NOT NULL, ENT_SRC_KEY VARCHAR(250) NOT NULL, OBS_ENT_HASH CHAR(40) NOT NULL, JSON_DATA CLOB, FIRST_SEEN_DT TIMESTAMP, LAST_SEEN_DT TIMESTAMP) ORGANIZE BY ROW;
